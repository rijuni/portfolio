...
import { SiTensorflow, SiKeras, SiOpencv, SiPytorch, SiScikitlearn, SiPandas, SiNumpy, SiJupyter, SiJavascript, SiMongodb, SiPostgresql, SiDocker, SiTailwindcss, SiVsco } from 'react-icons/si';
        ...
        >
          ...
          <div className="relative bg-[#1a1a1a]/90 backdrop-blur-sm rounded-lg p-4 sm:p-8 border border-[#ff6b00]/30 overflow-hidden shadow-[0_0_15px_rgba(255,107,0,0.1)] group-hover:shadow-[0_0_30px_rgba(255,107,0,0.2)] transition-all duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 relative z-10">
              ...
              <div className="space-y-3 sm:space-y-4">
                <h4 className="text-[#ff6b00] font-mono text-sm sm:text-base">Backend</h4>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="space-y-3 sm:space-y-4">
                <h4 className="text-[#ff6b00] font-mono text-sm sm:text-base">AI/ML</h4>
                <div className="flex flex-wrap gap-2">
