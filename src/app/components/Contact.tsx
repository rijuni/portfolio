...
export default function Contact() {
  ...
  useEffect(() => {
    // Initialize EmailJS
    emailjs.init('2fRFBVjyVpbWRVIHE');
  }, []);
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#a3a3a3] font-mono">amlannanda2000@gmail.com</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#a3a3a3] font-mono">+917377410135, +919040987577</p>
                      </div>
                    </div>
                  </div>
                </div>
